            ...
            <SimpleGrid columns={[1, null, 2]}>
              ...
              >
                ...
                <Text
                  ...
                  px={['1rem', null]}
                >
                  Imagine um lugar afastado das luzes da cidade, onde pais, mãs
                  e suas crianças possam observar as belezas de um céu super
                  estrelado! A Noite nas Estrelas é um acampamento astronômico
                  que acontece todos os anos na cidade de Brasília - DF. A
                  atividade tem marcado o coração de muitas famílias, nesse
                  magnifico momento de contato com a natureza celeste.
                  Oportunidade única para quem quer aproveitar um final de
                  semana de paz e tranquilidade e aprender um pouco mais sobre o
                  universo!
                </Text>
              </Flex>
            </SimpleGrid>
              ...
              >
                <Box bg="iceWhite" w="280px" h="140px" borderRadius="0.3rem">
                  <Flex justify="center">
                    ...
                    <Image src="/barraca.png" width="80px" height="75px" />
                  </Flex>
                ...
                <Box bg="iceWhite" w="280px" h="140px" borderRadius="0.3rem">
                  ...
                  <Flex direction="column" align="center">
                    ...
                    <Text
                      ...
                      lineHeight="1rem"
                    >
                      Momento simplesmente inesquecível! Observação celeste
                      guiada pelo instrutuor.
                    </Text>
                  </Flex>
                </Box>
                <Box bg="iceWhite" w="280px" h="140px" borderRadius="0.3rem">
                ...
                <Box bg="iceWhite" w="280px" h="140px" borderRadius="0.3rem">
                  <Flex justify="center">
                    ...
                    <Image src="/naturezaIcon.png" width="80px" height="75px" />
                  </Flex>
                  <Flex direction="column" align="center">
                    <Text fontWeight="bold" fontSize="1rem">
                      Natureza
                ...
                <Box bg="iceWhite" w="280px" h="140px" borderRadius="0.3rem">
                  <Flex justify="center">
                    ...
                    <Image src="/fogueiraIcon.png" width="80px" height="75px" />
                  </Flex>
                  <Flex direction="column" align="center">
                    <Text fontWeight="bold" fontSize="1rem">
                      Fogueira
